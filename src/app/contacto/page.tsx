            ...
            <div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 20.312c-3.606 0-6.533-2.926-6.533-6.533s2.927-6.533 6.533-6.533c3.607 0 6.533 2.926 6.533 6.533s-2.926 6.533-6.533 6.533zm7.071-10.641c-.897 0-1.625-.729-1.625-1.625s.728-1.625 1.625-1.625 1.625.729 1.625 1.625-.728 1.625-1.625 1.625zm-3.503 5.033c-2.209 0-4-1.791-4-4s1.791-4 4-4 4 1.791 4 4-1.791 4-4 4z"/>
                    </svg>
                  </a>
                  <a
